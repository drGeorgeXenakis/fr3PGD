...
function (weather, presc, t = 0, N = 4430, Wl = 0.01, WlDormant = 0, 
    ...
    m0 = 0.018, fN0 = 0.296, fNn = 1.27, MaxAge = 265.6, nAge = 3.545, 
    rAge = 0.796, gammaFx = 0.019, gammaF0 = 0.002, tgammaF = 80.79, 
    Rttover = 0, MaxCond = 0.028, LAIgcx = 3.092, BLcond = 0.013, 
    wSx1000 = 394.2, thinPower = 1.5, mF = 0.207, mR = 0.127, 
    mS = 0.128, SLA0 = 20.1, SLA1 = 22.88, tSLA = 16.33, k = 0.504, 
    fullCanAge = 22.32, MaxIntcptn = 0.382, LAImaxIntcptn = 6.302, 
    alpha = 0.047, Y = 0.473, poolFractn = 0, e20 = 2.2, rhoAir = 1.2, 
    lambda = 2460000, VPDconv = 0.000622, fracBB0 = 0.93, fracBB1 = 0.087, 
    tBB = 32.48, rhoMin = 0.342, rhoMax = 0.576, tRho = 128.1, 
    Qa = -90, Qb = 0.8, gDM_mol = 24, molPAR_MJ = 2.3, CoeffCond = 0.007, 
    fCalpha700 = 1.433, fCg700 = 0.451, fCalphax = 2.33333333333333, 
    fCg0 = 1.75, MinCond = 0.015, Wl.s = 0.526, Wsbr.s = 0.2035, 
    Wr.s = 0.22775, pWl.sprouts = 0.5, pWsbr.sprouts = 0.9, cod.pred = "3PG", 
    cod.clim = "Month", leaf.grow = 0, leaf.fall = 0) 
{
    ...
    names(parms) <- c("pFS2", "pFS20", "pfsPower", "pfsConst", 
        ...
        "pWsbr.sprouts", "leaf.grow", "leaf.fall")
